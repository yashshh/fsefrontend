...
class PaginationCompany extends Component {
    ...
    render() {
        ...
        return(
            <div className="container">
                ...
                <div class="row justify-content" style={{marginTop:"30px", borderRadius:"25px"}}>
                <CompanyDetailsComponent name={company.companyName} details={company.description} price={company.currentStockPrice} className={"btn"} btn={"companyDetailsComponent"} onClick={()=>this.handleClick(company.companyId)}>
